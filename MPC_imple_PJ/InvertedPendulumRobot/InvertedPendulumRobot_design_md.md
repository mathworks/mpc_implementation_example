...
eq = 
   ...
   <img src="https://latex.codecogs.com/gif.latex?&space;\begin{array}{l}&space;\left(\begin{array}{c}&space;{\left(\textrm{Jw}+M\,R^2&space;+R^2&space;\,m\right)}\,\theta^¨&space;+{\left(\textrm{Jw}+R^2&space;\,m+M\,R\,{\left(R+L\,\cos&space;\left(\psi&space;\right)\right)}\right)}\,\psi^¨&space;+\textrm{fw}\,\dot{\theta}&space;+\sigma_1&space;-F_{\theta&space;}&space;\\&space;{\left(\textrm{Jw}+M\,R^2&space;+R^2&space;\,m+L\,M\,R\,\cos&space;\left(\psi&space;\right)\right)}\,\theta^¨&space;+{\left(\textrm{Jpsi}+\textrm{Jw}+L^2&space;\,M+M\,R^2&space;+R^2&space;\,m+2\,L\,M\,R\,\cos&space;\left(\psi&space;\right)\right)}\,\psi^¨&space;+\sigma_1&space;+\textrm{fm}\,\dot{\psi}&space;-L\,M\,g\,\sin&space;\left(\psi&space;\right)&space;\end{array}\right)\\&space;\mathrm{}\\&space;\textrm{where}\\&space;\mathrm{}\\&space;\;\;\sigma_1&space;={\left(-L\,M\,R\,\sin&space;\left(\psi&space;\right)\right)}\,{\dot{\psi}&space;}^2&space;&space;\end{array}"/>
...
1ステップ当たりの平均計算時間は28.98ms、CPU使用率は289.8%である。
...
1ステップ当たりの平均計算時間は8.36ms、CPU使用率は39.12%である。
