...
```
f = 
 $\displaystyle \left(\begin{array}{c} V\,\cos \left(\theta \right)\newline V\,\sin \left(\theta \right)\newline r\newline -\frac{2\,{\left(K_f \,{l_f }^2 \,r+K_r \,{l_r }^2 \,r+K_f \,V\,\beta \,l_f -K_r \,V\,\beta \,l_r -K_f \,V\,\delta \,l_f \right)}}{\textrm{I}\,V}\newline -\frac{2\,K_f \,V\,\beta +2\,K_r \,V\,\beta -2\,K_f \,V\,\delta +2\,K_f \,l_f \,r-2\,K_r \,l_r \,r+V^2 \,m\,r}{V^2 \,m}\newline a \end{array}\right)$
...
```
h = 
 $\displaystyle \left(\begin{array}{c} \textrm{px}\newline \textrm{py}\newline \theta \newline r\newline V \end{array}\right)$
...
```
Ac = 
 $\displaystyle \left(\begin{array}{cccccc} 0 & 0 & -V\,\sin \left(\theta \right) & 0 & 0 & \cos \left(\theta \right)\newline 0 & 0 & V\,\cos \left(\theta \right) & 0 & 0 & \sin \left(\theta \right)\newline 0 & 0 & 0 & 1 & 0 & 0\newline 0 & 0 & 0 & -\frac{2\,{\left(K_f \,{l_f }^2 +K_r \,{l_r }^2 \right)}}{\textrm{I}\,V} & -\frac{2\,{\left(K_f \,V\,l_f -K_r \,V\,l_r \right)}}{\textrm{I}\,V} & \frac{2\,{\left(K_f \,{l_f }^2 \,r+K_r \,{l_r }^2 \,r+K_f \,V\,\beta \,l_f -K_r \,V\,\beta \,l_r -K_f \,V\,\delta \,l_f \right)}}{\textrm{I}\,V^2 }+\frac{2\,{\left(K_r \,\beta \,l_r -K_f \,\beta \,l_f +K_f \,\delta \,l_f \right)}}{\textrm{I}\,V}\newline 0 & 0 & 0 & -\frac{m\,V^2 +2\,K_f \,l_f -2\,K_r \,l_r }{V^2 \,m} & -\frac{2\,K_f \,V+2\,K_r \,V}{V^2 \,m} & \frac{2\,{\left(2\,K_f \,V\,\beta +2\,K_r \,V\,\beta -2\,K_f \,V\,\delta +2\,K_f \,l_f \,r-2\,K_r \,l_r \,r+V^2 \,m\,r\right)}}{V^3 \,m}-\frac{2\,K_f \,\beta +2\,K_r \,\beta -2\,K_f \,\delta +2\,V\,m\,r}{V^2 \,m}\newline 0 & 0 & 0 & 0 & 0 & 0 \end{array}\right)$
...
```
Cc = 
 $\displaystyle \left(\begin{array}{cccccc} 1 & 0 & 0 & 0 & 0 & 0\newline 0 & 1 & 0 & 0 & 0 & 0\newline 0 & 0 & 1 & 0 & 0 & 0\newline 0 & 0 & 0 & 1 & 0 & 0\newline 0 & 0 & 0 & 0 & 0 & 1 \end{array}\right)$
...
一方で、シナリオ"regular\_circle\_turn\_vehicle"は定常円旋回を行うシナリオである。以下のように、回転を続ける位置指令値に対して、一定距離を保ちながら追い続ける動作をする。
